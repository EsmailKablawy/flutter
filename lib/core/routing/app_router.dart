...
import '../../features/chat/ui/screens/chat_view.dart';
import '../../features/event/ui/screens/event_screen.dart';
import '../../features/favorite/ui/screens/favorite_view.dart';
  ...
  Route? generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case AppRoute.profileView:
        return CupertinoPageRoute(builder: (context) => const ProfileView());

      case AppRoute.notificationView:
        return CupertinoPageRoute(
            builder: (context) => const NotificationView());

      case AppRoute.favoriteView:
        return CupertinoPageRoute(builder: (context) => const FavoriteView());

      case AppRoute.chatView:
        return CupertinoPageRoute(builder: (context) => const ChatView());

      case AppRoute.reservationView:
        return CupertinoPageRoute(
