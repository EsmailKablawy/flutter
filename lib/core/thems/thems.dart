...
const Color mainColor = Color(0xFFE09FA3);
//background: #;
...
const Color secondMainColor =
    Color(0xFF68E07C); //background: var(--Color-Blue-Blue-50, #E6F4FF);
const Color whiteBlueColor = Color(
    0xFFE6F4FF); //background: var(--color-yellow-warning-yellow-500, #FFAA00);

const Color fesfourColor = Color(0xFFD7FA78);

const Color blackmainColor = Color(0xFF0E0E0E);

const Color primaryClr = Color(0xFFFDF3F3);
...
const Color primerymainColor = Color(0xFFE4E4FB); //##
const Color orangeClr = Color(0xFFFFAA00); //#E2F8E3
...
const Color greenClr = Color(0xFF12B76A);

const Color recGreyClr = Color(0xFFEB001B);

const Color blueOpacityClr = Color(0xFF5486E9);
const Color blueClr = Color(0xFF3B82F6);
const Color pinkClr = Color(0xFF6A25EB);
