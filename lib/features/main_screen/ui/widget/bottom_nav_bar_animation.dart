...
class BottomNavBarAnimation extends StatefulWidget {
  ...
  @override
  BottomNavBarAnimationState createState() => BottomNavBarAnimationState();
}

class BottomNavBarAnimationState extends State<BottomNavBarAnimation>
  ...
  @override
  void didUpdateWidget(BottomNavBarAnimation oldWidget) {
                        ...
                        child: Transform.translate(
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              ...
                              border:
                                  Border.all(color: greyClr.withOpacity(0.1)),
                              boxShadow: [
                                BoxShadow(
